...
namespace FinanceManager.ViewModel
{
     class TransactionsViewModel:BaseVM,ISaveObjectChanges
    {
        ...
        {
            if (service.Accounts.Count == 0) ErrorText = "Для выполнения \nтранзакции вам \nнеобходимо иметь хотя \nбы одну \nучетную запись.";
            else
            {
                if (Type == OperationType.Income)
                    ErrorText = Period switch
                    {
                        Period.Day => "Сегодня у вас \nнет дохода.",
                        Period.Week => "На этой неделе \nу вас нет дохода.",
                        Period.Month => "У вас нет дохода \nв этом месяце.",
                        Period.Year => "У вас нет дохода \nв этом году."
                    };
                else
                    ErrorText = Period switch
                    {
                        Period.Day => "У вас нет никаких \nрасходов в этот день.",
                        Period.Week => "У вас нет никаких \nрасходов на этой неделе.",
                        Period.Month => "У вас нет никаких \nрасходов в этом месяце.",
                        Period.Year => "У вас нет никаких \nрасходов в этом году."
                    };
            }
